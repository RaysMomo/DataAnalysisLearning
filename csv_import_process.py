...
with open("D:\Spider\Customs Data\import rmb.csv", "rt") as inrmbfile, open(
        "D:\Spider\Customs Data\import us dollar.csv", "rt") as inusfile:
    ...
    # print(import_df)
    import_df = import_df.reindex(columns=col_name, fill_value="进口")
    ...
    engine.dispose()
    # import_df.to_csv(r"D:\Spider\Customs Data\import processed.csv", encoding="utf-8-sig")
